...
function biddut_scripts() {
    ...
    */ 
    ...
    wp_enqueue_style( 'flaticon', BIDDUT_THEME_CSS_DIR . 'flaticon.css', [] );
    ...
    wp_enqueue_script( 'jquery-appear', BIDDUT_THEME_JS_DIR . 'jquery-appear.js', [ 'jquery' ], '', true );
    wp_enqueue_script( 'jquery-knob', BIDDUT_THEME_JS_DIR . 'jquery-knob.js', [ 'jquery' ], '', true );
    ...
    wp_enqueue_script( 'countdown', BIDDUT_THEME_JS_DIR . 'countdown.js', [ 'jquery' ], false, true );
