...
function biddut_scripts()
{
    ...
    wp_enqueue_script('slick', BIDDUT_THEME_JS_DIR . 'slick.js', ['jquery'], false, true);
    wp_enqueue_script('range-slider', BIDDUT_THEME_JS_DIR . 'range-slider.js', ['jquery'], false, true);
