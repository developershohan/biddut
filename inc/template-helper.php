...
<a class="icon twitter" href="<?php print esc_url( $biddut_topbar_twitter_url );?>"><i class="fa-brands fa-twitter"></i></a>
<?php endif;?>

<?php if ( !empty( $biddut_topbar_instagram_url ) ): ?>
<a class="icon youtube" href="<?php print esc_url( $biddut_topbar_instagram_url );?>"><i class="fa-brands fa-instagram"></i></a>
<?php endif;?>

<?php if ( !empty( $biddut_topbar_linkedin_url ) ): ?>
<a class="icon linkedin" href="<?php print esc_url( $biddut_topbar_linkedin_url );?>"><i class="fab fa-linkedin"></i></a>
<?php endif;?>
